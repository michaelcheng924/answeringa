  ...
  <Layout headData={{ title: "Privacy Policy" }}>
    <Container>
      <div className="writing">
        ...
        <p className="first">Effective date: April 24, 2019</p>

        <p>
          Answering Abortion ("us", "we", or "our") operates the
          http://answeringabortion.com website (the "Service").
        </p>
        ...
        <p>
          ...
          Answering Abortion is managed through{" "}
        ...
        <p>
          ...
          our Terms and Conditions, accessible from http://answeringabortion.com
        </p>
        ...
        <ul>
          <li>
            <h4>Session Cookies.</h4> We use Session Cookies to operate our
            Service.
          </li>
          <li>
            <h4>Preference Cookies.</h4> We use Preference Cookies to remember
            your preferences and various settings.
          </li>
          <li>
            <h4>Security Cookies.</h4> We use Security Cookies for security
            purposes.
          </li>
        </ul>
        ...
        <p>Answering Abortion uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          Answering Abortion will take all steps reasonably necessary to ensure
        ...
        <p>
          Answering Abortion may disclose your Personal Data in the good faith
          belief that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>
            To protect and defend the rights or property of Answering Abortion
          </li>
          <li>
        ...
        <p>
          ...
          third party's site. We h4ly advise you to review the Privacy Policy of
        ...
        <ul>
          <li>
            ...
            http://answeringabortion.com/contact
          </li>
        </ul>
      </div>
    </Container>
