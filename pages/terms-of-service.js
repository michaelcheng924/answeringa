...
const TermsOfService = () => (
  <Layout headData={{ title: "Privacy Policy" }}>
    <Container>
      <div className="writing">
        <h3>Welcome to Answering Abortion</h3>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of Answering Abortion's Website.
        </p>{" "}
        <br />
        ...
        <br />
        <br />
        <address>Houston, TX 77065</address>
        <p>
          By accessing this website we assume you accept these terms and
          conditions in full. Do not continue to use Answering Abortion's
        ...
        <h3>Cookies</h3>
        <p>
          We employ the use of cookies. By using Answering Abortion's website
          you consent to the use of cookies in accordance with Answering
          Abortion’s privacy policy.
        </p>
        <p>
        ...
        <h3>License</h3>
        <p>
          Unless otherwise stated, Answering Abortion and/or it’s licensors own
          the intellectual property rights for all material on Answering
          Abortion. All intellectual property rights are reserved. You may view
          and/or print pages from https://answeringabortion.com for your own
          personal use subject to restrictions set in these terms and
          conditions.
        </p>
        <p>You must not:</p>
        <ol>
          <li>Republish material from https://answeringabortion.com</li>
          <li>
            Sell, rent or sub-license material from
            https://answeringabortion.com
          </li>
          <li>
        ...
        <p>
          Redistribute content from Answering Abortion (unless content is
        ...
        <p>
          ...
          outweighs the absence of Answering Abortion; and (d) where the link is
        ...
        <p>
          No use of Answering Abortion’s logo or other artwork will be allowed
